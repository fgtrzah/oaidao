...
if TYPE_CHECKING:
    ...
    from ..models.create_chat_completion_response_choices_item_logprobs import (
...
class CreateChatCompletionResponseChoicesItem:
    ...
    Attributes:
        ...
        logprobs (Optional[CreateChatCompletionResponseChoicesItemLogprobs]): Log probability information for the
            choice.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if _logprobs is None:
            ...
            logprobs = CreateChatCompletionResponseChoicesItemLogprobs.from_dict(_logprobs)
