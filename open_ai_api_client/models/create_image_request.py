...
class CreateImageRequest:
    ...
    Attributes:
        ...
        n (Union[Unset, None, int]): The number of images to generate. Must be between 1 and 10. For `dall-e-3`, only
        ...
        style (Union[Unset, None, CreateImageRequestStyle]): The style of the generated images. Must be one of `vivid`
            or `natural`. Vivid causes the model to lean towards generating hyper-real and dramatic images. Natural causes
            the model to produce more natural, less hyper-real looking images. This param is only supported for `dall-e-3`.
    ...
    style: Union[Unset, None, CreateImageRequestStyle] = CreateImageRequestStyle.VIVID
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        style: Union[Unset, None, str] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_model(data: object) -> Union[CreateImageRequestModelType1, None, Unset, str]:
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                _model_type_1 = data
                model_type_1: Union[Unset, CreateImageRequestModelType1]
                if isinstance(_model_type_1, Unset):
                    model_type_1 = UNSET
                else:
                    model_type_1 = CreateImageRequestModelType1(_model_type_1)
        ...
        style: Union[Unset, None, CreateImageRequestStyle]
        if _style is None:
            style = None
        elif isinstance(_style, Unset):
            style = UNSET
        else:
