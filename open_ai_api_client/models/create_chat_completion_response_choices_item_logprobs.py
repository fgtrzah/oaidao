...
T = TypeVar("T", bound="CreateChatCompletionResponseChoicesItemLogprobs")
...
class CreateChatCompletionResponseChoicesItemLogprobs:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_chat_completion_response_choices_item_logprobs = cls(
            content=content,
        )

        create_chat_completion_response_choices_item_logprobs.additional_properties = d
        return create_chat_completion_response_choices_item_logprobs
