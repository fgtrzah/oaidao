...
class CreateFileRequest:
    ...
    Attributes:
        ...
        purpose (CreateFileRequestPurpose): The intended purpose of the uploaded file.
            ...
            Use "fine-tune" for [Fine-tuning](/docs/api-reference/fine-tuning) and "assistants" for [Assistants](/docs/api-
            reference/assistants) and [Messages](/docs/api-reference/messages). This allows us to validate the format of the
