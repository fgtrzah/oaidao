...
T = TypeVar("T", bound="ARunOnAThreadRequiredActionSubmitToolOutputs")


@_attrs_define
class ARunOnAThreadRequiredActionSubmitToolOutputs:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        a_run_on_a_thread_required_action_submit_tool_outputs = cls(
            tool_calls=tool_calls,
        )

        a_run_on_a_thread_required_action_submit_tool_outputs.additional_properties = d
        return a_run_on_a_thread_required_action_submit_tool_outputs
