...
if TYPE_CHECKING:
    ...
    from ..models.retrieval_tool_call import RetrievalToolCall
...
class ToolCalls:
    ...
    Attributes:
        ...
        tool_calls (List[Union['CodeInterpreterToolCall', 'FunctionToolCall', 'RetrievalToolCall']]): An array of tool
    ...
    type: ToolCallsType
    tool_calls: List[Union["CodeInterpreterToolCall", "FunctionToolCall", "RetrievalToolCall"]]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        for tool_calls_item_data in self.tool_calls:
            ...
            elif isinstance(tool_calls_item_data, RetrievalToolCall):
                tool_calls_item = tool_calls_item_data.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for tool_calls_item_data in _tool_calls:
            ...
            def _parse_tool_calls_item(
                data: object,
            ) -> Union["CodeInterpreterToolCall", "FunctionToolCall", "RetrievalToolCall"]:
                try:
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    tool_calls_item_type_1 = RetrievalToolCall.from_dict(data)
