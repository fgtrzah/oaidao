...
if TYPE_CHECKING:
    from ..models.modify_run_request_metadata import ModifyRunRequestMetadata
...
class ModifyRunRequest:
    """
    Attributes:
        metadata (Union[Unset, None, ModifyRunRequestMetadata]): Set of 16 key-value pairs that can be attached to an
    ...
    metadata: Union[Unset, None, "ModifyRunRequestMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, None, ModifyRunRequestMetadata]
        if _metadata is None:
            metadata = None
        elif isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = ModifyRunRequestMetadata.from_dict(_metadata)
