...
T = TypeVar("T", bound="CreateChatCompletionRequestLogitBias")
...
class CreateChatCompletionRequestLogitBias:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        create_chat_completion_request_logit_bias = cls()

        create_chat_completion_request_logit_bias.additional_properties = d
        return create_chat_completion_request_logit_bias
