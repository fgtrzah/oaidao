...
if TYPE_CHECKING:
    ...
    from ..models.create_run_request_metadata import CreateRunRequestMetadata
...
class CreateRunRequest:
    ...
    Attributes:
        ...
        metadata (Union[Unset, None, CreateRunRequestMetadata]): Set of 16 key-value pairs that can be attached to an
    ...
    metadata: Union[Unset, None, "CreateRunRequestMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        metadata: Union[Unset, None, CreateRunRequestMetadata]
        if _metadata is None:
            metadata = None
        elif isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CreateRunRequestMetadata.from_dict(_metadata)
