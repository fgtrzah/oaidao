...
from ..models.list_fine_tune_events_response_object import ListFineTuneEventsResponseObject
...
class ListFineTuneEventsResponse:
    ...
    Attributes:
        ...
        object_ (ListFineTuneEventsResponseObject):
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        object_ = ListFineTuneEventsResponseObject(d.pop("object"))
