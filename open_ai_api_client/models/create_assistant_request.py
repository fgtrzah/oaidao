...
if TYPE_CHECKING:
    ...
    from ..models.create_assistant_request_metadata import CreateAssistantRequestMetadata
...
class CreateAssistantRequest:
    ...
    Attributes:
        ...
        file_ids (Union[Unset, List[str]]): A list of [file](/docs/api-reference/files) IDs attached to this assistant.
            ...
            ascending order.
        metadata (Union[Unset, None, CreateAssistantRequestMetadata]): Set of 16 key-value pairs that can be attached to
    ...
    metadata: Union[Unset, None, "CreateAssistantRequestMetadata"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_model(data: object) -> str:
        ...
        metadata: Union[Unset, None, CreateAssistantRequestMetadata]
        if _metadata is None:
            metadata = None
        elif isinstance(_metadata, Unset):
            metadata = UNSET
        else:
            metadata = CreateAssistantRequestMetadata.from_dict(_metadata)
