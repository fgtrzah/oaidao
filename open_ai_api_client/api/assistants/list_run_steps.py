...
def _get_kwargs(
    ...
    *,
    ...
    order: Union[Unset, None, ListRunStepsOrder] = ListRunStepsOrder.DESC,
    ...
    return {
        "method": "get",
        "url": "/threads/{thread_id}/runs/{run_id}/steps".format(
            thread_id=thread_id,
            run_id=run_id,
        ),
        "params": params,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order (Union[Unset, None, ListRunStepsOrder]):  Default: ListRunStepsOrder.DESC.
