...
def _get_kwargs(
    ...
    *,
    ...
    order: Union[Unset, None, ListMessagesOrder] = ListMessagesOrder.DESC,
    ...
    return {
        "method": "get",
        "url": "/threads/{thread_id}/messages".format(
            thread_id=thread_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order (Union[Unset, None, ListMessagesOrder]):  Default: ListMessagesOrder.DESC.
