...
from ...models.list_runs_order import ListRunsOrder
...
def _get_kwargs(
    ...
    *,
    ...
    order: Union[Unset, None, ListRunsOrder] = ListRunsOrder.DESC,
    ...
    return {
        "method": "get",
        "url": "/threads/{thread_id}/runs".format(
            thread_id=thread_id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        order (Union[Unset, None, ListRunsOrder]):  Default: ListRunsOrder.DESC.
